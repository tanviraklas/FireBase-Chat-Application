    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder holder, int position)
    {
        ...
        UserDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.get().load(userImage).placeholder(R.drawable.default_pro_pic).into(holder.userProfileImage);
        ...
        else
        {
            ...
            Picasso.get().load(messages.getMessage()).placeholder(R.drawable.default_pro_pic).into(holder.messagePicture);
        }

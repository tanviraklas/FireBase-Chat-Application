...
public class StatusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveChangeButton = (Button) findViewById(R.id.save_status_change_btn);
    ...
    private void ChangeProfileStatus(String new_status)
    {
        ...
        else
        {
            ...
            loadingbar.setMessage("Please Wait, While Updaing Your Status....");
            loadingbar.show();
            ...
            changeStatusRef.child("user_status").setValue(new_status)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            {
                                Toast.makeText(StatusActivity.this,"Error Occurred During Status Update !",Toast.LENGTH_SHORT).show();
